...
public class Remove_Employee implements ActionListener{
    ...
    Remove_Employee(){
        ...
        b.setFont(new Font("sans serif",Font.PLAIN,15));
        b.addActionListener(this);
        l5.add(b);

        b3=new JButton("Back");
        b3.setBounds(360,100,100,30); 
        b3.setFont(new Font("sans serif",Font.PLAIN,15));
        ...
        l6=new JLabel();    
        l6.setBounds(200,200,350,30);
        l6.setForeground(Color.black);
        Font F6=new Font("sans serif",Font.PLAIN,20); 
        l6.setFont(F6);
        l5.add(l6);
        ...
        Font F5=new Font("sans serif",Font.PLAIN,20); 
        l4.setFont(F5);
        l5.add(l4);
        ...
        Font f8=new Font("sans serif",Font.PLAIN,20); 
        l8.setFont(f8);
        l5.add(l8);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource()==b){
            try{
                conn con = new conn();
                String str = "select name,email_id from employee where emp_id ='"+t.getText()+"' ";
